...
import { localizeProduct, getPromotionPrice, getEffectivePrice } from '@/lib/store';
      ...
      <div className="container-mobile">
        ...
        <div className="pt-6 pb-4 sm:hidden">
          ...
          <div className="mt-1 flex items-baseline gap-2">
            <p className="text-[15px] text-black/50">{formatDzd(effectivePrice, locale)}</p>
            {promotionPrice ? (
              <p className="text-[12px] text-black/35 line-through">{formatDzd(product.priceDzd, locale)}</p>
            ) : null}
          </div>
        </div>
